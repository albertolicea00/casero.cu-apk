...
If you find a security issue in the Android client, please open an issue **without** including credentials, tokens, or real guest data.

- **Android-specific** → [open an issue](https://github.com/albertolicea00/casero.cu-apk/issues/new)
...
- **Changes to `casero.rem.cu` or the USSD/SMS codes** that break the app — these are critical, report them immediately
