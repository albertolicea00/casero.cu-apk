#!/usr/bin/env node
/**
 * USSD sync check — CASERO (Android).
 *
 ...
 * `UssdSmsReporter` still ships `*TODO*{passport}#` placeholders, and the
 * canonical `casero-report` collection is a placeholder too.
 *
...
async function main() {
  ...
  if (placeholders.length > 0) {
    ...
    say(`\`USSD_TEMPLATE\` / \`SMS_DESTINATION\` placeholders in \`UssdSmsReporter\`.`);
    finish(true);
    return;
  }
